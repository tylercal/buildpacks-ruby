...
- Updated libcnb to 0.31.0, which includes OpenTelemetry crate upgrades. ([#517](https://github.com/heroku/buildpacks-ruby/pull/517))
...
- Changed the S3 URLs used for downloads to use AWS' dual-stack (IPv6 compatible) endpoint. ([#483](https://github.com/heroku/buildpacks-ruby/pull/483))
...
- Updated requires for Node.js tooling. ([#452](https://github.com/heroku/buildpacks-ruby/pull/452))
...
- Removed statsd based metrics collection agent (associated with the `barnes` gem). Fir uses OTel and does not support statsd metrics collection ([#429](https://github.com/heroku/buildpacks-ruby/pull/429))
...
[12.2.0]: https://github.com/heroku/buildpacks-ruby/compare/v12.1.0...v12.2.0
[12.1.0]: https://github.com/heroku/buildpacks-ruby/compare/v12.0.0...v12.1.0
[12.0.0]: https://github.com/heroku/buildpacks-ruby/compare/v11.0.0...v12.0.0
[11.0.0]: https://github.com/heroku/buildpacks-ruby/compare/v10.1.0...v11.0.0
...
[8.0.0]: https://github.com/heroku/buildpacks-ruby/compare/v7.0.1...v8.0.0
